...
values ('Terry John', 60000.00, 10295396939285, 03928690340, 5.0);

insert into SalesEmployees (SalesEmployee_Name,SalesEmployee_Salary,SalesEmployee_BankAccountNum,SalesEmployee_NationalInsuranceNum,SalesEmployee_CommissionRate)
values ('John Clean', 40000.00, 2843905783828, 0795832959, 5.00);

insert into SalesEmployees (SalesEmployee_Name,SalesEmployee_Salary,SalesEmployee_BankAccountNum,SalesEmployee_NationalInsuranceNum,SalesEmployee_CommissionRate)
values ('Dean Smith', 45000.00, 6758473625143, 0694873849, 5.00);

insert into SalesEmployees (SalesEmployee_Name,SalesEmployee_Salary,SalesEmployee_BankAccountNum,SalesEmployee_NationalInsuranceNum,SalesEmployee_CommissionRate)
values ('Clara Sting', 65000.00, 877476375837, 657463527, 9.00);

insert into SalesEmployees (SalesEmployee_Name,SalesEmployee_Salary,SalesEmployee_BankAccountNum,SalesEmployee_NationalInsuranceNum,SalesEmployee_CommissionRate)
values ('Seana Green', 70000.00, 3457342095949, 756473736, 7.00);
